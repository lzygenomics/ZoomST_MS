...
Rather than enforcing exact pointwise equality between transformed and directly encoded coarse states, we constrain their relationship statistically over matched locations~\citep{lenc2015equivariance}:
\begin{equation}
